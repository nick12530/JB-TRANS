  ...
  return (
    <div className={`space-y-2 ${className}`}>
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {/* Dropdown */}
        {isOpen && (
          <div className="absolute z-[9999] w-full mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl max-h-60 overflow-hidden min-w-max left-0 right-0 sm:min-w-0">
            {/* Search Input */}
            {searchable && (
                ...
                filteredOptions.map((option) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-medium break-words whitespace-normal">{option.label}</div>
                      {option.description && (
                        <div className="text-xs text-gray-500 dark:text-gray-400 break-words whitespace-normal">
                          {option.description}
                        </div>
                      )}
                    </div>
